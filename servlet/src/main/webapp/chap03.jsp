...
<br>
<br>
Get, Post 방식으로 들어온 값들을 저장하여 출력한다.<br>
Get 방식은 쿼리스트링 방식으로 받을 수 있다.<br>
들어온 파라미터들은 모두 String 형태로 들어와 int나 date와 같은 다른 타입은 변환해줘야 한다.
<br>
<br>
...
<form action="querystring" method="get">
    ...
    <button>GET 요청</button>     <!-- 설명.버튼 태그는 타입이 없으면 기본적으로 submit 버튼이다.-->
</form>
...
<form action="formdata" method="post">
    ...
    <button>POST 요청</button>    <!-- 설명.버튼 태그는 타입이 없으면 기본적으로 submit 버튼이다.-->
</form>
</body>
</html>
